...
The exported repo includes `Scripts/verify_public_site_export.rb` and `docs/PUBLIC_SITE_EXPORT_ASSERTIONS.json` so public CI can fail if page metadata, Open Graph, Twitter, support links, required launch copy, or device ecosystem asset checksums drift.
